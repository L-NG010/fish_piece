...
import 'package:fish_it_kasir/widgets/kasir/receipt.dart';
import 'package:flutter/material.dart';

class DialogPembayaran extends StatelessWidget {
  final double harga;
  
  const DialogPembayaran({super.key, required this.harga});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Harga"),
            SizedBox(height: 5),
            _textBox(harga.toStringAsFixed(0).replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]}.',)),
